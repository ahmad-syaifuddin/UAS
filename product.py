...
class Ui_DataView(object):
    ...
    DB_CONFIG = {
        ...
        "user": "root",
        "password": "",
        "database": "db_penjualan" ##########UBAH$DISINI#############
    }
    TABLE_NAME = "product" ##########UBAH$DISINI#############
    ...
    FIELDS = [
        ...
        ("barkode", "Barkode", 30, 90, 150, 90), ##########UBAH$DISINI#############
        ("name", "Nama", 30, 150, 150, 150), ##########UBAH$DISINI#############
        ("kategori", "Kategori", 30, 210, 150, 210), ##########UBAH$DISINI#############
        ("qty", "Jumlah", 30, 270, 150, 270), ##########UBAH$DISINI#############
        ("harga", "Harga", 30, 330, 150, 330), ##########UBAH$DISINI#############
    ]
